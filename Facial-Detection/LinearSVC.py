...
class SVC_facial_detection():
    ...
    def train_model(self):
        ...
        svc = svm.LinearSVC(dual=auto, max_iters=1000, random_state=42)
        ...
        random_search = RandomizedSearchCV(
            svc, param_distributions=param_dist, n_iters=10, cv=5, n_jobs=-1, random_state=42
        )
        end_time = time.time()
        elapsed_time = end_time - start_time
        print("Done tuning hyper-params in " + elapsed_time + " seconds")
        ...
        end_time = time.time()
        elapsed_time = end_time - start_time
        print("Done Training Model in " + elapsed_time + " seconds")
        ...
        print("Training accuracy score: " + self.training_accuracy)
